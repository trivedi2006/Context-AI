...
export const SidebarLeft: React.FC<SidebarLeftProps> = ({
  ...
  return (
    <div className="w-72 h-full bg-[#0d0d0f] border-r border-white/[0.08] flex flex-col justify-between shrink-0 select-none overflow-hidden font-sans relative">
      ...
      <div className="p-4 border-b border-white/[0.06] space-y-3 shrink-0">
        ...
        <button
          onClick={onNewChatUpload}
          className="w-full py-2.5 px-3.5 rounded-xl bg-white text-black font-medium text-xs flex items-center justify-center gap-2 shadow-lg shadow-white/5 hover:bg-white/90 active:scale-[0.98] transition-all cursor-pointer font-['Space_Grotesk']"
        >
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-3 py-1.5 rounded-lg bg-white/[0.04] border border-white/[0.06] text-xs text-white placeholder-white/30 focus:outline-none focus:border-white/20 transition-all font-sans"
          />
        </div>
      </div>
              ...
              <div key={doc.id} className="space-y-1 rounded-xl bg-white/[0.02] border border-white/[0.04] p-1.5">
                ...
                <div className="flex items-center justify-between p-2 rounded-lg hover:bg-white/[0.04] transition-colors group">
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      onClick={() => onNewChatForDocument(doc.id)}
                      className="p-1 rounded text-white/40 hover:text-emerald-400 hover:bg-white/10 transition-colors"
                        ...
                        docSessions.map((session) => {
                          ...
                          return (
                            <div
                              ...
                              className={`group/session flex items-center justify-between p-2 rounded-lg text-xs cursor-pointer transition-all ${
                                isActive
                            ...
                            >
                              ...
                              <button
                                ...
                                className="p-1 rounded text-white/0 group-hover/session:text-white/40 hover:!text-red-400 hover:bg-white/10 transition-all"
      ...
      <div className="p-3 border-t border-white/[0.06] bg-[#0d0d0f] shrink-0">
          ...
          {showProfileMenu && (
            ...
            >
              ...
              <button
                ...
                className="w-full py-2 px-3 rounded-lg bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 text-red-400 text-xs font-medium flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
        ...
        <button
          ...
          className="w-full flex items-center justify-between p-2 rounded-xl bg-white/[0.02] hover:bg-white/[0.06] transition-all cursor-pointer border border-white/[0.04] hover:border-white/10"
        >
